...
path_elife_articles_folder = os.path.dirname(os.path.abspath(elife_articles_master))    # find the path to the folder containing the MGB output files. The folder is in the current directory 

# or because the elife_articles_master is in the working directory, I can simply put 
# from elife_articles_master 

print "the path to elife_articles_master is", path_elife_articles_folder
